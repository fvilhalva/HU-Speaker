...
def synthesize(request: SynthesisRequest, auth: AuthContext = Depends(require_service_jwt)) -> SynthesisResponse:
...
def get_synthesis_status(synthesis_id: str, auth: AuthContext = Depends(require_service_jwt)) -> dict[str, str]:
...
def download_audio(synthesis_id: str, auth: AuthContext = Depends(require_service_jwt)) -> FileResponse:
...
def delete_audio(synthesis_id: str, auth: AuthContext = Depends(require_service_jwt)) -> DeletionResponse:
